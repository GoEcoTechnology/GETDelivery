              ...
              vehicles.map((vehicle) => (
                <tr key={vehicle.id}>
                  ...
                  <td style={{ textAlign: 'right' }}>
                    <button onClick={() => setEditModal(vehicle)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#3b82f6', padding: '8px' }}>
                      <Edit2 size={16} />
                    </button>
                    <button onClick={() => handleDelete(vehicle.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#ef4444', padding: '8px' }}>
                      <Trash2 size={16} />
                    </button>
                  </td>
                </tr>
