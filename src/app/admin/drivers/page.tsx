...
import { Search, Edit2, Trash2, UserPlus, ChevronLeft, ChevronRight, X } from 'lucide-react';
              ...
              drivers.map((driver) => (
                <tr key={driver.id}>
                  ...
                  <td style={{ textAlign: 'right' }}>
                    <button onClick={() => setEditModal(driver)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#3b82f6', padding: '8px' }}>
                      <Edit2 size={16} />
                    </button>
                    <button onClick={() => handleDelete(driver.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#ef4444', padding: '8px' }}>
                      <Trash2 size={16} />
                    </button>
                  </td>
                </tr>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(15, 23, 42, 0.6)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '24px' }}>
          <div style={{ backgroundColor: 'white', borderRadius: '16px', padding: '32px', width: '100%', maxWidth: '400px', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)' }}>
            ...
            <form onSubmit={handleAdd}>
              ...
              <div style={{ marginBottom: '16px' }}>
                <label className={styles.label}>Mobile Number (for SMS)</label>
